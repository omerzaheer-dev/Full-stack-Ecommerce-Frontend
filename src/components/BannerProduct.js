    ...
    <div className='container mx-auto px-4 rounded'>
      <div className='w-full h-72 bg-slate-200 md:flex relative overflow-hidden hidden'>
        <div className="absolute w-full top-[50%] translate-y-[-50%] z-10">
            ...
            <button onClick={previousImage}  className="w-9 h-9 bg-white font-bold text-xl hover:text-2xl duration-100 rounded shadow-md flex justify-center items-center">
                <FaAngleLeft/>
            </button>
                <button onClick={nextImage}  className="w-9 h-9 bg-white font-bold text-xl hover:text-2xl duration-100 rounded shadow-md flex justify-center items-center">
                    <FaAngleRight/>
                </button>
            </div>
        </div>
