                            ...
                            <div className="md:min-w-full md:max-w-full mt-[5px] md:mt-2 mx-auto">
                              {
                                ...
                                <div className="border-red-600 border-[2px] hover:bg-red-600 hover:text-white mx-auto w-[100%] bg-white py-[1px] px-3 md:px-6 text-center text-red-600 font-medium rounded-full"onClick={(e)=>{ AddToCart(e,product?._id,dispatch,user)}}>Remove from Cart</div>
                                :
